...
public class ProvUtilities {
    ...
    static public boolean hasType(QualifiedName type, Collection<Attribute> attributes) {
    ...
    public Object getter(Statement s, int i) {
        ...
        case PROV_ALTERNATE: {
            final AlternateOf a = (AlternateOf) s;
            switch (i) {
            case 0:
        ...
        case PROV_ASSOCIATION: {
            final WasAssociatedWith a = (WasAssociatedWith) s;
            switch (i) {
            case 0:
                return a.getId();
            case 1:
        ...
        case PROV_ATTRIBUTION: {
            final WasAttributedTo a = (WasAttributedTo) s;
            switch (i) {
            case 0:
                return a.getId();
            case 1:
        ...
        case PROV_COMMUNICATION: {
            final WasInformedBy a = (WasInformedBy) s;
            switch (i) {
            case 0:
                return a.getId();
            case 1:
        ...
        case PROV_DELEGATION: {
            final ActedOnBehalfOf a = (ActedOnBehalfOf) s;
            switch (i) {
            case 0:
                return a.getId();
            case 1:
        ...
        case PROV_DERIVATION: {
            final WasDerivedFrom a = (WasDerivedFrom) s;
            switch (i) {
            case 0:
                return a.getId();
            case 1:
        ...
        case PROV_DICTIONARY_REMOVAL:
            throw new InvalidCaseException("ProvUtilities.getter() for " + kind);
        case PROV_END: {
            final WasEndedBy a = (WasEndedBy) s;
            switch (i) {
            case 0:
                return a.getId();
            case 1:
        ...
        case PROV_GENERATION: {
            final WasGeneratedBy a = (WasGeneratedBy) s;
            switch (i) {
            case 0:
                return a.getId();
            case 1:
        ...
        case PROV_INFLUENCE: {
            final WasInfluencedBy a = (WasInfluencedBy) s;
            switch (i) {
            case 0:
                return a.getId();
            case 1:
        ...
        case PROV_INVALIDATION: {
            final WasInvalidatedBy a = (WasInvalidatedBy) s;
            switch (i) {
            case 0:
                return a.getId();
            case 1:
        ...
        case PROV_SPECIALIZATION: {
            final SpecializationOf a = (SpecializationOf) s;
            switch (i) {
            case 0:
                return a.getSpecificEntity();
            case 1:
        ...
        case PROV_START: {
            final WasStartedBy a = (WasStartedBy) s;
            switch (i) {
            case 0:
                return a.getId();
            case 1:
    ...
    public void setter(Statement s, int i, Object val) {
        ...
        case PROV_MEMBERSHIP: {
            ...
            case 1:
                ...
                return; // FIXME: only supporting one value in the membership
            default:
                throw new ArrayIndexOutOfBoundsException("ProvUtilities.setter() for " + kind
                                                         + " and index " + i);
            }
        ...
        case PROV_MENTION: {
            ...
            case 2: a.setBundle((QualifiedName)val); return;
    ...
    public void updateNamespaces(Document document) {
        ...
        for (Bundle bu: getBundle(document)) {

...
final public class ModelConstructor implements org.openprovenance.prov.model.ModelConstructor, AtomConstructor {
    ...
    @Override
    public org.openprovenance.prov.model.Activity newActivity(org.openprovenance.prov.model.QualifiedName id, XMLGregorianCalendar startTime, XMLGregorianCalendar endTime, Collection<Attribute> attributes) {
        return new Activity(id,startTime,endTime,attributes);
    }
    ...
    public org.openprovenance.prov.model.Agent newAgent(org.openprovenance.prov.model.QualifiedName id, Collection<Attribute> attributes) {
        return new Agent(id,attributes);
    }

    @Override
    public org.openprovenance.prov.model.AlternateOf newAlternateOf(org.openprovenance.prov.model.QualifiedName e1, org.openprovenance.prov.model.QualifiedName e2) {
        return new AlternateOf(e1,e2);
    }

    @Override
    public DerivedByInsertionFrom newDerivedByInsertionFrom(org.openprovenance.prov.model.QualifiedName id, org.openprovenance.prov.model.QualifiedName after, org.openprovenance.prov.model.QualifiedName before, List<org.openprovenance.prov.model.Entry> keyEntitySet, Collection<Attribute> attributes) {
        return new DerivedByInsertionFrom(id,after, before,keyEntitySet,attributes);
    }

    @Override
    public DerivedByRemovalFrom newDerivedByRemovalFrom(org.openprovenance.prov.model.QualifiedName id, org.openprovenance.prov.model.QualifiedName after, org.openprovenance.prov.model.QualifiedName before, List<Key> keys, Collection<Attribute> attributes) {
        return new DerivedByRemovalFrom(id, after, before, keys, attributes);
    }

    @Override
    public org.openprovenance.prov.model.DictionaryMembership newDictionaryMembership(org.openprovenance.prov.model.QualifiedName dict, List<org.openprovenance.prov.model.Entry> keyEntitySet) {
        return new DictionaryMembership(null,dict,keyEntitySet,null);
    }

    @Override
    public DictionaryMembership newDictionaryMembership(org.openprovenance.prov.model.QualifiedName id, org.openprovenance.prov.model.QualifiedName dict, List<Entry> keyEntitySet, Collection<Attribute> attributes) {
    ...
    public MentionOf newMentionOf(org.openprovenance.prov.model.QualifiedName e2, org.openprovenance.prov.model.QualifiedName e1, org.openprovenance.prov.model.QualifiedName b) {
        return new org.openprovenance.prov.vanilla.MentionOf(e2,e1,b);
    }
     ...
     */
    @Override
    public Bundle newNamedBundle(org.openprovenance.prov.model.QualifiedName id, Namespace namespace, Collection<Statement> statements) {
        return new Bundle(id,namespace,statements);
    }

    /**
     * A factory method for {@link org.openprovenance.prov.model.QualifiedName}. A qualified name consists of a namespace, denoted by an optional prefix, and a local name.
     *
     * @param namespace a URI for the namespace
     * @param local     a local name
     * @param prefix    a string, which can be null.
     * @return an instance of {@link org.openprovenance.prov.model.QualifiedName}
     */
    @Override
    ...
    @Override
    public org.openprovenance.prov.model.SpecializationOf newSpecializationOf(org.openprovenance.prov.model.QualifiedName e2, org.openprovenance.prov.model.QualifiedName e1) {
        return new SpecializationOf(e2,e1);
    }
     ...
     */
    @Override
    public org.openprovenance.prov.model.Used newUsed(org.openprovenance.prov.model.QualifiedName id, org.openprovenance.prov.model.QualifiedName activity, org.openprovenance.prov.model.QualifiedName entity, XMLGregorianCalendar time, Collection<Attribute> attributes) {
        return new Used(id,activity,entity,time,attributes);
    }
     ...
     */
    @Override
    public org.openprovenance.prov.model.WasAttributedTo newWasAttributedTo(org.openprovenance.prov.model.QualifiedName id, org.openprovenance.prov.model.QualifiedName entity, org.openprovenance.prov.model.QualifiedName agent, Collection<Attribute> attributes) {
     ...
     */
    @Override
    public org.openprovenance.prov.model.WasGeneratedBy newWasGeneratedBy(org.openprovenance.prov.model.QualifiedName id, org.openprovenance.prov.model.QualifiedName entity, org.openprovenance.prov.model.QualifiedName activity, XMLGregorianCalendar time, Collection<Attribute> attributes) {
     ...
     */
    @Override
    public org.openprovenance.prov.model.WasInfluencedBy newWasInfluencedBy(org.openprovenance.prov.model.QualifiedName id, org.openprovenance.prov.model.QualifiedName influencee, org.openprovenance.prov.model.QualifiedName influencer, Collection<Attribute> attributes) {
     ...
     */
    @Override
    public org.openprovenance.prov.model.WasInformedBy newWasInformedBy(org.openprovenance.prov.model.QualifiedName id, org.openprovenance.prov.model.QualifiedName informed, org.openprovenance.prov.model.QualifiedName informant, Collection<Attribute> attributes) {
     ...
     */
    @Override
    public org.openprovenance.prov.model.WasStartedBy newWasStartedBy(org.openprovenance.prov.model.QualifiedName id, org.openprovenance.prov.model.QualifiedName activity, org.openprovenance.prov.model.QualifiedName trigger, org.openprovenance.prov.model.QualifiedName starter, XMLGregorianCalendar time, Collection<Attribute> attributes) {
        return new WasStartedBy(id,activity,trigger,starter,time,attributes);
    }

    @Override
    public void startBundle(org.openprovenance.prov.model.QualifiedName bundleId, Namespace namespace) {
    ...
    @Override
    public org.openprovenance.prov.model.Other newOther(org.openprovenance.prov.model.QualifiedName elementName, Object value, org.openprovenance.prov.model.QualifiedName type) {
        return new Other(elementName,type,value);
    }

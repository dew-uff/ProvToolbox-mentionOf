...
public class ProvFactory extends org.openprovenance.prov.model.ProvFactory implements LiteralConstructor, ModelConstructor, ModelConstructorExtension, AtomConstructor {
    ...
    @Override
    public Type newType(Object value, org.openprovenance.prov.model.QualifiedName type) {
    ...
    @Override
    public org.openprovenance.prov.model.Activity newActivity(org.openprovenance.prov.model.QualifiedName q, String label) {
    ...
    @Override
    public org.openprovenance.prov.model.Entry newEntry(org.openprovenance.prov.model.Key key, org.openprovenance.prov.model.QualifiedName entity) {
    ...
    @Override
    public Value newValue(Object value, org.openprovenance.prov.model.QualifiedName type) {
        if (value==null) return null;
    ...
    public org.openprovenance.prov.model.Agent newAgent(org.openprovenance.prov.model.QualifiedName ag, String label) {
        org.openprovenance.prov.model.Agent res = newAgent(ag);
    ...
    public org.openprovenance.prov.model.Used newUsed(org.openprovenance.prov.model.QualifiedName activity, org.openprovenance.prov.model.QualifiedName entity) {
        return newUsed((org.openprovenance.prov.model.QualifiedName)null, activity, entity);
    }
    ...
    @Override
    public Used newUsed(org.openprovenance.prov.model.QualifiedName id,
                        org.openprovenance.prov.model.QualifiedName activity,
                        org.openprovenance.prov.model.QualifiedName entity,
                        XMLGregorianCalendar time) {
    ...
    @Override
    public Role newRole(Object value, org.openprovenance.prov.model.QualifiedName type) {
        if (value==null) return null;
    ...
    @Override
    public WasGeneratedBy newWasGeneratedBy(org.openprovenance.prov.model.QualifiedName id, org.openprovenance.prov.model.QualifiedName entity, org.openprovenance.prov.model.QualifiedName activity, XMLGregorianCalendar time, Collection<Attribute> attributes) {
    ...
    public org.openprovenance.prov.model.WasInvalidatedBy newWasInvalidatedBy(org.openprovenance.prov.model.QualifiedName id,
                                                                              ...
                                                                              XMLGregorianCalendar time,
                                                                              Collection<Attribute> attributes) {
        WasInvalidatedBy res=mc.newWasInvalidatedBy(id,entity,activity,time,attributes);
        res.setTime(time);
        return res;
    }
     ...
     */
    @Override
    public WasAttributedTo newWasAttributedTo(org.openprovenance.prov.model.QualifiedName id,
                                              org.openprovenance.prov.model.QualifiedName entity,
                                              org.openprovenance.prov.model.QualifiedName agent,
                                              Collection<Attribute> attributes) {
    ...
    @Override
    public SpecializationOf newSpecializationOf(org.openprovenance.prov.model.QualifiedName specific, org.openprovenance.prov.model.QualifiedName general) {
     ...
     */
    @Override
    public AlternateOf newAlternateOf(org.openprovenance.prov.model.QualifiedName entity1, org.openprovenance.prov.model.QualifiedName entity2) {
        return mc.newAlternateOf(entity1,entity2);
    }

    @Override
    public org.openprovenance.prov.model.DerivedByInsertionFrom newDerivedByInsertionFrom(org.openprovenance.prov.model.QualifiedName id, org.openprovenance.prov.model.QualifiedName after, org.openprovenance.prov.model.QualifiedName before, List<org.openprovenance.prov.model.Entry> keyEntitySet, Collection<Attribute> attributes) {
        return new DerivedByInsertionFrom(id,after,before,keyEntitySet,attributes);
    }

    @Override
    public org.openprovenance.prov.model.DerivedByRemovalFrom newDerivedByRemovalFrom(org.openprovenance.prov.model.QualifiedName id, org.openprovenance.prov.model.QualifiedName after, org.openprovenance.prov.model.QualifiedName before, List<org.openprovenance.prov.model.Key> keys, Collection<Attribute> attributes) {
        return new DerivedByRemovalFrom(id,after,before,keys,attributes);
    }

    @Override
    public org.openprovenance.prov.model.DictionaryMembership newDictionaryMembership(org.openprovenance.prov.model.QualifiedName id, org.openprovenance.prov.model.QualifiedName dict, List<org.openprovenance.prov.model.Entry> keyEntitySet, Collection<Attribute> attributes) {
    ...
    @Override
    public org.openprovenance.prov.model.Document newDocument(Collection<org.openprovenance.prov.model.Activity> ps,
                                                              Collection<org.openprovenance.prov.model.Entity> as,
                                                              Collection<org.openprovenance.prov.model.Agent> ags,
                                                              Collection<Statement> lks) {
        org.openprovenance.prov.model.Document res = newDocument();
    ...
    @Override
    public org.openprovenance.prov.model.Document newDocument(org.openprovenance.prov.model.Document graph) {
        org.openprovenance.prov.model.Document res = newDocument();
    ...
    @Override
    public WasInformedBy newWasInformedBy(org.openprovenance.prov.model.QualifiedName id,
                                          org.openprovenance.prov.model.QualifiedName informed,
                                          org.openprovenance.prov.model.QualifiedName informant,
                                          Collection<Attribute> attributes) {
    ...
    @Override
    public WasInfluencedBy newWasInfluencedBy(org.openprovenance.prov.model.QualifiedName id,
                                              org.openprovenance.prov.model.QualifiedName influencee,
                                              org.openprovenance.prov.model.QualifiedName influencer,
                                              Collection<Attribute> attributes) {
    ...
    @Override
    public MentionOf newMentionOf(org.openprovenance.prov.model.QualifiedName e2, org.openprovenance.prov.model.QualifiedName e1, org.openprovenance.prov.model.QualifiedName b) {
        return mc.newMentionOf(e2,e1,b);
    }
     ...
     */
    @Override
    public WasStartedBy newWasStartedBy(org.openprovenance.prov.model.QualifiedName id,
                                        org.openprovenance.prov.model.QualifiedName activity,
                                        org.openprovenance.prov.model.QualifiedName trigger,
                                        org.openprovenance.prov.model.QualifiedName starter,
                                        XMLGregorianCalendar time,
     ...
     */
    @Override
    public WasEndedBy newWasEndedBy(org.openprovenance.prov.model.QualifiedName id,
                                    org.openprovenance.prov.model.QualifiedName activity,
                                    org.openprovenance.prov.model.QualifiedName trigger,
                                    org.openprovenance.prov.model.QualifiedName ender,
                                    XMLGregorianCalendar time,
     ...
     */
    @Override
    public org.openprovenance.prov.model.Document newDocument(Namespace namespace,
                                                              Collection<Statement> statements,
                                                              Collection<org.openprovenance.prov.model.Bundle> bundles) {
        org.openprovenance.prov.model.Document res = newDocument();
     ...
     */
    @Override
    public ActedOnBehalfOf newActedOnBehalfOf(org.openprovenance.prov.model.QualifiedName id, org.openprovenance.prov.model.QualifiedName delegate, org.openprovenance.prov.model.QualifiedName responsible) {
        return mc.newActedOnBehalfOf(id,delegate,responsible,null,new LinkedList<>());
    }

    @Override
    public org.openprovenance.prov.model.Bundle newNamedBundle(org.openprovenance.prov.model.QualifiedName id, Collection<Statement> statements) {
        return newNamedBundle(id,null,statements);
    }

    @Override
    public org.openprovenance.prov.model.Bundle newNamedBundle(org.openprovenance.prov.model.QualifiedName id, Namespace namespace, Collection<Statement> statements) {
        return mc.newNamedBundle(id,namespace,statements);
    }


    @Override
    public Bundle newNamedBundle(org.openprovenance.prov.model.QualifiedName id, Collection<Activity> ps, Collection<Entity> as, Collection<Agent> ags, Collection<Statement> lks) {
    ...
    @Override
    public org.openprovenance.prov.model.extension.QualifiedHadMember newQualifiedHadMember(org.openprovenance.prov.model.QualifiedName id, org.openprovenance.prov.model.QualifiedName c, Collection<org.openprovenance.prov.model.QualifiedName> e, Collection<Attribute> attributes) {
        return new QualifiedHadMember(id, c, e, attributes);
    }

    @Override
    public org.openprovenance.prov.model.extension.QualifiedSpecializationOf newQualifiedSpecializationOf(org.openprovenance.prov.model.QualifiedName id, org.openprovenance.prov.model.QualifiedName specific, org.openprovenance.prov.model.QualifiedName general, Collection<Attribute> attributes) {
        return new QualifiedSpecializationOf(id, specific, general, attributes);
    }

    @Override
    public org.openprovenance.prov.model.extension.QualifiedAlternateOf newQualifiedAlternateOf(org.openprovenance.prov.model.QualifiedName id, org.openprovenance.prov.model.QualifiedName alt1, QualifiedName alt2, Collection<Attribute> attributes) {

...
public interface JSON_SortedDocument {
    ...
    @JsonSerialize(keyUsing = CustomQualifiedNameSerializerAsField.class, contentAs = MentionOf.class)
    @JsonDeserialize(keyUsing = CustomKeyDeserializer.class, contentAs = MentionOf.class )
    public Map<org.openprovenance.prov.model.QualifiedName, MentionOf> getMentionOf();
